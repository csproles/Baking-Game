        ...
        if(number == 1){
            ...
            if(Constants.CAKE_TYPE_VANILLA){
                if(Constants.CAKE_MIXED && !(Constants.CAKE_BAKED) && !(Constants.CAKE_DECORATED)){
                    playerFile = new File(Constants.PLAYER_FRONT_UNBAKED_VANILLA_STEP1_IMAGEPATH);
                }
                else if(Constants.CAKE_MIXED && Constants.CAKE_BAKED && !(Constants.CAKE_DECORATED)){
                    playerFile = new File(Constants.PLAYER_FRONT_BAKED_VANILLA_STEP1_IMAGEPATH);
                }
                else if(Constants.CAKE_MIXED && Constants.CAKE_BAKED && Constants.CAKE_DECORATED){
                    playerFile = new File(Constants.PLAYER_FRONT_WITH_BOX_STEP1_IMAGEPATH);
                }
            }
            else if(Constants.CAKE_TYPE_CHOCOLATE){
                if(Constants.CAKE_MIXED && !(Constants.CAKE_BAKED) && !(Constants.CAKE_DECORATED)){
                    playerFile = new File(Constants.PLAYER_FRONT_UNBAKED_CHOCOLATE_STEP1_IMAGEPATH);
                }
                else if(Constants.CAKE_MIXED && Constants.CAKE_BAKED && !(Constants.CAKE_DECORATED)){
                    playerFile = new File(Constants.PLAYER_FRONT_BAKED_CHOCOLATE_STEP1_IMAGEPATH);
                }
                else if(Constants.CAKE_MIXED && Constants.CAKE_BAKED && Constants.CAKE_DECORATED){
                    playerFile = new File(Constants.PLAYER_FRONT_WITH_BOX_STEP1_IMAGEPATH);
                }
            ...
            if(Constants.CAKE_TYPE_VANILLA){
                if(Constants.CAKE_MIXED && !(Constants.CAKE_BAKED) && !(Constants.CAKE_DECORATED)){
                    playerFile = new File(Constants.PLAYER_FRONT_UNBAKED_VANILLA_STEP2_IMAGEPATH);
                }
                else if(Constants.CAKE_MIXED && Constants.CAKE_BAKED && !(Constants.CAKE_DECORATED)){
                    playerFile = new File(Constants.PLAYER_FRONT_BAKED_VANILLA_STEP2_IMAGEPATH);
                }
                else if(Constants.CAKE_MIXED && Constants.CAKE_BAKED && Constants.CAKE_DECORATED){
                    playerFile = new File(Constants.PLAYER_FRONT_WITH_BOX_STEP2_IMAGEPATH);
                }
            }
            else if(Constants.CAKE_TYPE_CHOCOLATE){
                if(Constants.CAKE_MIXED && !(Constants.CAKE_BAKED) && !(Constants.CAKE_DECORATED)){
                    playerFile = new File(Constants.PLAYER_FRONT_UNBAKED_CHOCOLATE_STEP2_IMAGEPATH);
                }
                else if(Constants.CAKE_MIXED && Constants.CAKE_BAKED && !(Constants.CAKE_DECORATED)){
                    playerFile = new File(Constants.PLAYER_FRONT_BAKED_CHOCOLATE_STEP2_IMAGEPATH);
                }
                else if(Constants.CAKE_MIXED && Constants.CAKE_BAKED && Constants.CAKE_DECORATED){
                    playerFile = new File(Constants.PLAYER_FRONT_WITH_BOX_STEP2_IMAGEPATH);
                }
